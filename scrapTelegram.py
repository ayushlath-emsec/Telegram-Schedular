...
async def telegram_scrap_func(url,_id):
    ...
    data = {'channel_id':channel_id,'chat':chat,'user_id':user_Id,'media_link':media_link,"is_media":media1_status,'chat_ID': chat_ID,'chat_Date': chat_Date,'createdAt':createdAt_date}
